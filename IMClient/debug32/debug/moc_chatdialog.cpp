...
QT_MOC_LITERAL(1, 11, 15), // "sig_sendMessage"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 8), // "friendId"
QT_MOC_LITERAL(4, 37, 7), // "content"
QT_MOC_LITERAL(5, 45, 18) // "on_pb_send_clicked"

    },
    "ChatDialog\0sig_sendMessage\0\0friendId\0"
    "content\0on_pb_send_clicked"
};
...
void ChatDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_sendMessage((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChatDialog::sig_sendMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChatDialog::sig_sendMessage(int _t1, QString _t2)
{
