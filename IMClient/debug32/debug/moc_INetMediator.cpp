...
QT_MOC_LITERAL(1, 13, 16), // "sig_transmitData"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 5), // "char*"
QT_MOC_LITERAL(4, 37, 4), // "data"
QT_MOC_LITERAL(5, 42, 3), // "len"
QT_MOC_LITERAL(6, 46, 4) // "from"

    },
    "INetMediator\0sig_transmitData\0\0char*\0"
    "data\0len\0from"
};
...
void INetMediator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_transmitData((*reinterpret_cast< char*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< ulong(*)>(_a[3]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (INetMediator::*)(char * , int , unsigned long );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&INetMediator::sig_transmitData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void INetMediator::sig_transmitData(char * _t1, int _t2, unsigned long _t3)
{
