...
QT_MOC_LITERAL(1, 11, 11), // "sig_offlien"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 13), // "sig_addFriend"
QT_MOC_LITERAL(4, 38, 18), // "on_pb_menu_clicked"
QT_MOC_LITERAL(5, 57, 14), // "slot_triggered"
QT_MOC_LITERAL(6, 72, 8), // "QAction*"
QT_MOC_LITERAL(7, 81, 6) // "action"

    },
    "FriendList\0sig_offlien\0\0sig_addFriend\0"
    "on_pb_menu_clicked\0slot_triggered\0"
    "QAction*\0action"
};
...
void FriendList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_offlien(); break;
        case 1: _t->sig_addFriend(); break;
        case 2: _t->on_pb_menu_clicked(); break;
        case 3: _t->slot_triggered((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FriendList::sig_offlien)) {
                *result = 0;
                return;
            }
        }
